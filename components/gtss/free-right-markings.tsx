...
// Pedestrian markings drawn across a free-right slip lane, ported from the
// official GTSS-Signal-Builder app (client/src/components/gtss/free-right-markings.tsx).
//
...
export function freeRightPedMarkings(frMode: number, opts: FreeRightMarkingOpts) {
    ...
    const pt = (across: number, up: number): [number, number] => [cx + across * ax + up * ux, cy + across * ay + up * uy];
